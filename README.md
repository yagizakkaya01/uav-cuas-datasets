...
<p align="center">
  ...
  <br>
  <sub><i>Concept illustration of the C2 engine (detect → propagate risk → replan route). Synthetic scenario — not real data.</i></sub>
</p>
...
- **Project:** UAV/SIHA Field Operations — Spatial-Semantic Threat Mapping & C2 Engine
